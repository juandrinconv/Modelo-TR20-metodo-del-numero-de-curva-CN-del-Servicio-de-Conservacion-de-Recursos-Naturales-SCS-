...
class Basin(basins.Basin):
    ...
    def __init__(self, area, cn, tc, runoff_dist, peak_factor, landa, **kwargs):
        """A watershed draining to a node with hydrology attributes, dimensions, and methods.

        Args:
            area (float): The delineated region concentrating to a point, in :math:`acres`. (Hay que trabajar en milllasssss, por diossss!!!!)
    ...
    def initial_abstraction(self):
        return self.landa * self.potential_retention
