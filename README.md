...
# 4. Notas importantes
1. Se agregó el archivo en Python llamado "codigo_completo.py", el cual contiene el codigo del TR20 hecho por otros compañeros de la maestría. Resulta importante destacar, que dicho código contempla varias cosas, como por ejemplo, el análisis de la incertidumbre. En todo caso y, para que el código se ajuste a las necesidades que requiera cada persona, se recomienda clonar el código en cuestión y revisarlo minuciosamente.