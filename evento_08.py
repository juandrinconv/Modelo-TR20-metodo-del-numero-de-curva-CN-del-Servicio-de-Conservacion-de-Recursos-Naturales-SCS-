...
qobs_path = r"C:\Users\LENOVO\Downloads\Modelo_TR20\Caudales_Precipitaciones_08_10_07\Caudales observados.csv"
pobs_path = r"C:\Users\LENOVO\Downloads\Modelo_TR20\Caudales_Precipitaciones_08_10_07\Precipitaciones observadas.csv"
...
# 2. Los datos no deben contar con encabezado, es decir, solo deben estar los valores
...
qobs_data['Datetime'] = pd.to_datetime(
    qobs_data['Datetime'], format='%m/%d/%y %H:%M'
)
pobs_data['Datetime'] = pd.to_datetime(
    pobs_data['Datetime'], format='%m/%d/%y %H:%M'
)
